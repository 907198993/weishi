...
import com.heikesong.weishi.adapter.SearchResultAdapter;

import java.util.ArrayList;
import java.util.List;

public class AddressActivity extends AppCompatActivity implements LocationSource,
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(AddressActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    InputtipsQuery inputquery = new InputtipsQuery(newText, "成都");
                    Inputtips inputTips = new Inputtips(AddressActivity.this, inputquery);
...
//        Log.i("MY", "doSearchQuery");
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(AddressActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(AddressActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(AddressActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(AddressActivity.this, "erroCode " + rCode , Toast.LENGTH_SHORT).show();
            }
        }
    };
